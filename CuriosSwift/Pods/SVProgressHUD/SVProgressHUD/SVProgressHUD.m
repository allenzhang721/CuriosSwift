...
- (CAShapeLayer *)ringLayer {
    if(!_ringLayer) {
        ...
        [self.hudView.contentView.layer addSublayer:_ringLayer];
    }
    return _ringLayer;
}
...
- (CAShapeLayer *)backgroundRingLayer {
    if(!_backgroundRingLayer) {
        ...
        [self.hudView.contentView.layer addSublayer:_backgroundRingLayer];
    }
...
//        _hudView.backgroundColor = SVProgressHUDBackgroundColor;
        ...
        _hudView = [[UIVisualEffectView alloc] initWithEffect:effect];
...
- (UILabel *)stringLabel {
    ...
    if(!_stringLabel.superview)
        [self.hudView.contentView addSubview:_stringLabel];
